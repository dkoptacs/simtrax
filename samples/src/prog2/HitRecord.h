...
private:                // public for better performance? 
  ...
  int ObjId;            // integer ID for the object - currently an array index
...
public: 
  ...
  int getObjId() const {return ObjId;};   // ObjId component
